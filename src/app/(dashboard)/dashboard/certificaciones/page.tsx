  ...
  return (
    <div className="flex flex-1 items-center justify-center bg-gray-50">
      <div className="text-center max-w-sm px-6">
        ...
        <h1 className="text-xl font-extrabold text-[#085041] mb-2">Certificaciones</h1>
        <p className="text-sm text-gray-500 leading-relaxed mb-6">
          Pronto podrás gestionar y mostrar tus certificaciones GlobalGAP, Orgánico, Fairtrade y más directamente desde tu perfil.
        </p>
