  ...
  return (
    <>
      ...
      <main className="pt-16">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8">
              {[t("planesPage.trust1"), t("planesPage.trust2"), t("planesPage.trust3")].map((tr) => (
                <div key={tr} className="inline-flex items-center gap-2 text-sm font-medium text-white/90">
                  <span className="flex items-center justify-center h-5 w-5 rounded-full bg-[#1D9E75]">
        ...
        {/* ── SECTION 4 · Why MARKARU (value comparison) ── */}
        <section className="py-20 sm:py-24 bg-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-extrabold text-[#085041] mb-3">{t("planesPage.whyTitle")}</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
              ...
              {/* MARKARU — highlighted */}
              <div className="relative rounded-2xl bg-[#085041] text-white p-6 flex flex-col shadow-2xl ring-2 ring-[#1D9E75] md:-mt-3 md:mb-3">
                <span className="absolute -top-3.5 left-1/2 -translate-x-1/2 inline-flex items-center gap-1 bg-[#1D9E75] text-white text-[11px] font-bold px-3 py-1 rounded-full shadow whitespace-nowrap">
                  <Star className="h-3 w-3" /> {t("planesPage.compMarkaruBadge")}
                </span>
                <p className="text-lg font-extrabold mb-4">MARKARU</p>
                <p className="inline-flex items-start gap-2 text-sm font-bold text-white mb-3">
                  <Check className="h-4 w-4 text-[#4CD9A4] flex-shrink-0 mt-0.5" /> {t("planesPage.compMarkaruPrice")}
                </p>
                <p className="text-sm text-green-100 leading-relaxed mb-4">{t("planesPage.compMarkaruExample")}</p>
                <div className="mt-auto inline-flex items-center justify-center gap-2 bg-[#1D9E75] rounded-xl py-2.5 text-sm font-extrabold">
        ...
        <section className="py-20 sm:py-24 bg-gray-50">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10">
              <h2 className="inline-flex items-center gap-2 text-3xl sm:text-4xl font-extrabold text-[#085041]">
        ...
        <footer className="bg-gray-900 py-8">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <p className="text-xs text-gray-600">© {new Date().getFullYear()} MARKARU</p>
          </div>
        </footer>
      </main>
    </>
